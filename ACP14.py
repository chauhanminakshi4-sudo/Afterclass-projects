...
def greet_customer():
    print("Welcome to the Art Supplied Store!")
    print("Get your colors, brushes, and paper here.")

# PART 2:Call the greet_customer function
greet_customer() 

# PART 3:Ask for the price per item and the number of itmes brought
...
# PART 4: Defin a function that takes arguments and returns the total cost
...
# PART 6: Use a bulit_in function to round the total, then print it 
...
def thank_you_message(items):
    if items >= 5:
        ...
        return "Thanks for shipping at the art supplies store!"
