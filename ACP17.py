...
print(f"This parking ticket cost {ticket_price} units.")
...
while True:
    ...
    # PART 5: Add the valid coin to the unning total
    total_inserted += coin
    coins_inserted += 1
    print(f"Inserted {coin}. Total so far: {total_inserted}\n")

    # PART 6: Stop asking for coins once the total has been inserted
