...
print("Repeated Samples Marks:", sample_marks)
...
# PART 7: Function to fing marks that start and end with same digit
def match_marks(marks_list):
    count = 0
    matched_marks = []
...
print("Samllest mark is:", marks[0])
